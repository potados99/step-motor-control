...
#define _STEP_RATE (int)(360 / _STEP_ANGLE * 2)
#define _MAX_SPEED 2100



void main_routine() {
  for (unsigned register int i = 400; i < _MAX_SPEED; i += 100) {
    rotate(1, i, _ROTATION_CCW);
  }
...
void rotate(int _rotations, double _speed, int _direction) {
